...
/**
 * The TestCaseData class contains information about a test method.
 *
 ...
 */
data class TestCaseData(val name: String, val testClassName: String, val psiMethod: PsiMethod)
